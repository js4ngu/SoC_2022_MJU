...
HD_PWD='C:/Users/SEP16/SoC_2022_MJU/LAB8/Lab8-DMAFlow/solution1/impl/verilog/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adder5.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adder5.tcl -notrace
