...
HD_PWD='C:/Users/SEP16/SoC_2022_MJU/LAB8/Lab8-DMAFlow/solution1/impl/verilog/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder5.tcl
