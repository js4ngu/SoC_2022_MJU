...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("in_r_TDATA", 8, hls_in, 3, "axis", "in_data", 1),
	Port_Property("in_r_TVALID", 1, hls_in, 3, "axis", "in_vld", 1),
	Port_Property("in_r_TREADY", 1, hls_out, 3, "axis", "in_acc", 1),
	Port_Property("c_TDATA", 32, hls_out, 4, "axis", "out_data", 1),
	Port_Property("c_TVALID", 1, hls_out, 4, "axis", "out_vld", 1),
	Port_Property("c_TREADY", 1, hls_in, 4, "axis", "out_acc", 1),
