...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("arrayA_TDATA", 8, hls_in, 3, "axis", "in_data", 1),
	Port_Property("arrayA_TVALID", 1, hls_in, 3, "axis", "in_vld", 1),
	Port_Property("arrayA_TREADY", 1, hls_out, 3, "axis", "in_acc", 1),
	Port_Property("arrayB_TDATA", 8, hls_in, 4, "axis", "in_data", 1),
	Port_Property("arrayB_TVALID", 1, hls_in, 4, "axis", "in_vld", 1),
	Port_Property("arrayB_TREADY", 1, hls_out, 4, "axis", "in_acc", 1),
	Port_Property("arrayR_TDATA", 32, hls_out, 5, "axis", "out_data", 1),
	Port_Property("arrayR_TVALID", 1, hls_out, 5, "axis", "out_vld", 1),
	Port_Property("arrayR_TREADY", 1, hls_in, 5, "axis", "out_acc", 1),
...
const char* HLS_Design_Meta::dut_name = "mul_Matrix";
