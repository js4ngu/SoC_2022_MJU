...
HD_PWD='C:/Users/SEP16/SoC_2022_MJU/HW2/HW2_HLS/solution1/impl/verilog/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mul_Matrix.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mul_Matrix.tcl
