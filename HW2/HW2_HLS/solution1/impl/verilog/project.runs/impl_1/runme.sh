...
HD_PWD='C:/Users/SEP16/SoC_2022_MJU/HW2/HW2_HLS/solution1/impl/verilog/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mul_Matrix.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mul_Matrix.tcl -notrace
