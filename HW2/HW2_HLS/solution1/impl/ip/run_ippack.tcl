...
set Library     "hls"
set IPName      "mul_Matrix"
set Version     "1.0"
set DisplayName "Mul_matrix"
set Revision    "2105260359"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 useLM W 0x0 "Data signal of useLM" {{0 32 useLM W 0 "Bit 31 to 0 Data signal of useLM"}}} {0x18 useLN W 0x0 "Data signal of useLN" {{0 32 useLN W 0 "Bit 31 to 0 Data signal of useLN"}}} {0x20 useLP W 0x0 "Data signal of useLP" {{0 32 useLP W 0 "Bit 31 to 0 Data signal of useLP"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS arrayA arrayB arrayR"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
