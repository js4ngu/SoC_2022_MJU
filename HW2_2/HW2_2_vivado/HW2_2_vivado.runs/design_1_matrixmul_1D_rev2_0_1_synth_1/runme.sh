...
HD_PWD='C:/SoC_2022_MJU/HW2_2/HW2_2_vivado/HW2_2_vivado.runs/design_1_matrixmul_1D_rev2_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_matrixmul_1D_rev2_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_matrixmul_1D_rev2_0_1.tcl
