...
typedef struct {
    ...
    XMatrixmul_1d_rev2_uio_map maps[ MAX_UIO_MAPS ];
} XMatrixmul_1d_rev2_uio_info;

/***************** Variable Definitions **************************************/
static XMatrixmul_1d_rev2_uio_info uio_info;
...
static int uio_info_read_name(XMatrixmul_1d_rev2_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XMatrixmul_1d_rev2_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XMatrixmul_1d_rev2_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XMatrixmul_1d_rev2_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XMatrixmul_1d_rev2_Initialize(XMatrixmul_1d_rev2 *InstancePtr, const char* InstanceName) {
	XMatrixmul_1d_rev2_uio_info *InfoPtr = &uio_info;
