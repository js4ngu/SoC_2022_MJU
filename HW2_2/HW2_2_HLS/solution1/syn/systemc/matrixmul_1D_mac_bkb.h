...
#ifndef __matrixmul_1D_mac_bkb__HH__
#define __matrixmul_1D_mac_bkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(matrixmul_1D_mac_bkb) {
    ...
    SC_CTOR(matrixmul_1D_mac_bkb):  simcore_mac_0_U ("simcore_mac_0_U") {
