...
HD_PWD='C:/Users/SEP16/SoC_2022_MJU/HW2_2/HW2_2_HLS/solution1/impl/verilog/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log matrixmul_1D_rev2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source matrixmul_1D_rev2.tcl
