...
if {[file isfile matrixmul_1D_rev2.autotvin.dat]} {
	file delete -force matrixmul_1D_rev2.autotvin.dat
}

if {[file isfile matrixmul_1D_rev2.autotvout.dat]} {
	file delete -force matrixmul_1D_rev2.autotvout.dat
}
