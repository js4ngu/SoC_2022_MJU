set C_TypeInfoList {{ 
"matrixmul_1D_rev2" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"Input": [[], {"array": [ {"scalar": "unsigned char"}, [32768]]}] }, {"AB": [[], {"array": [ {"scalar": "unsigned int"}, [16384]]}] }],[],""]
}}
...
set C_modelArgList {
	{ Input_r int 8 regular {array 32768 { 1 3 } 1 1 }  }
	{ AB int 32 regular {array 16384 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "Input_r", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "Input","cData": "unsigned char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 32767,"step" : 1}]}]}]} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "6357475", "EstimateLatencyMax" : "6357475",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "6357475", "Max" : "6357475"}
	, {"Name" : "Interval", "Min" : "6357476", "Max" : "6357476"}
]}
